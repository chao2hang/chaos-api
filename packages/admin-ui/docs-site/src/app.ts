...
const codeSamples: Record<string, string> = {
  react: `import { AdminButton, AdminPage } from '@chaos_team/admin-ui-react'\n\n<AdminPage title="Channels">\n  <AdminButton variant="primary">Deploy New</AdminButton>\n</AdminPage>`,
  vue: `<script setup lang="ts">\nimport { AdminButton, AdminPage } from '@chaos_team/admin-ui-vue'\n</script>\n\n<AdminPage title="Channels">\n  <AdminButton variant="primary">Deploy New</AdminButton>\n</AdminPage>`,
  svelte: `<script lang="ts">\nimport { AdminButton, AdminPage } from '@chaos_team/admin-ui-svelte/components'\n</script>\n\n<AdminPage title="Channels">\n  <AdminButton variant="primary">Deploy New</AdminButton>\n</AdminPage>`,
  web: `import { registerAdminElements } from '@chaos_team/admin-ui-core/register'\nimport '@chaos_team/admin-ui-core/styles.css'\n\nregisterAdminElements()\n\n<aui-button variant="primary">Deploy New</aui-button>`,
};
...
root.innerHTML = `
  <aside class="docs-sidebar">
    <a class="brand" href="#overview" data-nav="overview" aria-label="Chaos Admin UI home">
...
root.querySelector(".copy-install")?.addEventListener("click", async (event) => {
  ...
  await navigator.clipboard?.writeText(
    "bun add @chaos_team/admin-ui-react @chaos_team/admin-ui-core",
  );
