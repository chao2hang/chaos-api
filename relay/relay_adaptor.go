...
import (
	...
	_ "github.com/chaos-api/chaos-api/plugins"
	"github.com/chaos-api/chaos-api/relay/channel"
	"github.com/chaos-api/chaos-api/relay/channel/advancedcustom"
	"github.com/chaos-api/chaos-api/relay/channel/ali"
	"github.com/chaos-api/chaos-api/relay/channel/aws"
	"github.com/chaos-api/chaos-api/relay/channel/baidu"
	"github.com/chaos-api/chaos-api/relay/channel/baidu_v2"
	"github.com/chaos-api/chaos-api/relay/channel/claude"
	"github.com/chaos-api/chaos-api/relay/channel/cloudflare"
	"github.com/chaos-api/chaos-api/relay/channel/codex"
	"github.com/chaos-api/chaos-api/relay/channel/cohere"
	"github.com/chaos-api/chaos-api/relay/channel/coze"
	"github.com/chaos-api/chaos-api/relay/channel/deepseek"
	"github.com/chaos-api/chaos-api/relay/channel/dify"
	"github.com/chaos-api/chaos-api/relay/channel/gemini"
	"github.com/chaos-api/chaos-api/relay/channel/jimeng"
	"github.com/chaos-api/chaos-api/relay/channel/jina"
	"github.com/chaos-api/chaos-api/relay/channel/minimax"
	"github.com/chaos-api/chaos-api/relay/channel/mistral"
	"github.com/chaos-api/chaos-api/relay/channel/mokaai"
	"github.com/chaos-api/chaos-api/relay/channel/moonshot"
	"github.com/chaos-api/chaos-api/relay/channel/newapi"
	"github.com/chaos-api/chaos-api/relay/channel/ollama"
	"github.com/chaos-api/chaos-api/relay/channel/openai"
	"github.com/chaos-api/chaos-api/relay/channel/palm"
	"github.com/chaos-api/chaos-api/relay/channel/perplexity"
	"github.com/chaos-api/chaos-api/relay/channel/replicate"
	"github.com/chaos-api/chaos-api/relay/channel/siliconflow"
	"github.com/chaos-api/chaos-api/relay/channel/sub2api"
	"github.com/chaos-api/chaos-api/relay/channel/submodel"
	jspluginadaptor "github.com/chaos-api/chaos-api/relay/channel/task/jsplugin"
	"github.com/chaos-api/chaos-api/relay/channel/tencent"
	"github.com/chaos-api/chaos-api/relay/channel/vertex"
	"github.com/chaos-api/chaos-api/relay/channel/volcengine"
	"github.com/chaos-api/chaos-api/relay/channel/xai"
	"github.com/chaos-api/chaos-api/relay/channel/xunfei"
	"github.com/chaos-api/chaos-api/relay/channel/zhipu"
	"github.com/chaos-api/chaos-api/relay/channel/zhipu_4v"
