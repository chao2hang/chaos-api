...
type ResponsesOutput struct {
	...
	// Summary carries reasoning summaries emitted by OpenAI reasoning models
	// ({"type":"summary_text","text":...}); raw reasoning text lives in Content
	// and is only returned when explicitly included upstream.
